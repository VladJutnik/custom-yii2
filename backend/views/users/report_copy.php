...
<div class="users-report-form container">
    <?php
            ...
            if ($regions) {
                ...
                foreach ($regions as $region)//цикл по регионам
                {
                    ...
                    $organizations = Organization::find()
                        ...
                        ->andWhere(['not in', 'title', array('МБОУ "Кияйская СШ"', 'Роспотребнадзор', 'город Новосибирск', 'ФБУН "Новосибирский НИИ гигиены" Роспотребнадзора', 'Лагерь ДОЛ Солнечный')])
                        ->andWhere(['type_org' => 1])
                    ...
                    if ($count_organizations && ($prev_region !== $cur_region)) {
                ...
                //if ($prev_district != $cur_district) {
                    ...
                    $table .= '<td colspan="2">' . $model->get_district($district->id) . ' кек</td>';
