...
$this->title = 'Регистрация в программном средстве "Питание и мониторинг здоровья"';
...
$type_orgs = TypeOrganization::find()->where(['id' => [3, 5, 6, 4, 7, 2]])->orderby(['name' => SORT_ASC])->all();
    ...
    <div class="site-signup m-4">
        ...
        <div class="row">
            <div class="col-12">
                ...
                <?= $form->field($model, 'post', $two_column)->textInput(['class' => 'form-control col-4'])->label('Должность руководителя') ?>

                <?= $form->field($model, 'name', $two_column)->textInput(['class' => 'form-control col-4'])->label('ФИО руководителя') ?>
